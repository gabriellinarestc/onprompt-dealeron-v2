...
import { CrawlerLogsView } from "@/features/crawlerLogs/CrawlerLogsView"
import { mockRealistic, mockEmpty, mockError } from "@/features/crawlerLogs/mocks"
...
export default function CrawlerLogsDevPage() {
      ...
      <div className="border-b border-border bg-card px-6 py-3">
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-sm font-bold text-foreground">Crawler Logs</h1>
          </div>
