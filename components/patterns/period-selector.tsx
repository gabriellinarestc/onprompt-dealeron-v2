    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="end" sideOffset={6} className="w-72 p-5 shadow-xl">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm font-semibold text-foreground">Compare to prior period</p>
            <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
              Shows whether your numbers went up or down compared to the previous {days} days.
            </p>
          </div>
          <Switch
            checked={compare}
        ...
        <div className="mt-4 rounded-lg bg-muted px-3 py-2.5 text-xs leading-relaxed text-muted-foreground">
          {compare
            ? <>You are viewing the <strong className="text-foreground">last {days} days</strong>, compared against the <strong className="text-foreground">{days} days before that</strong>.</>
